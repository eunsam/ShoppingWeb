...
<style>
	...
	div.goods div.goodsInfo { float:right; width:330px; font-size:16px; }
	div.goods div.goodsInfo p { margin:0 0 20px 0; }
	div.goods div.goodsInfo p span { display:inline-block; width:100px; margin-right:15px; }
 
	div.goods div.goodsInfo p.cartStock input { font-size:16px; width:50px; padding:5px; margin:0; border:1px solid #eee; }
...
div.modalContent { position:fixed; top:20%; left:calc(50% - 250px); width:425px; height:300px; padding:20px 10px; background:#fff; border:2px solid #666; }
div.modalContent textarea { font-size:15px; font-family:'맑은 고딕', verdana; padding:10px; width:400px; height:200px; }
	...
	$.getJSON("/shop/view/replyList" + "?n=" + gdsNum, function(data) {
		...
		$(data).each(function(){
			...
			repDate = repDate.toLocaleDateString("ko-US")
					...
					+ "<c:if test='${member != null}'>" //로그인이 되어있을 때 수정/삭제 버튼 생성
	...
	<section id="container">
			...
			<section id="content">
				...
				<form role="form" method="post">
					<input type="hidden" name="gdsName" value="${view.gdsNum}" />
				</form>
				...
				<div class="goods">
					...
					<div class="goodsInfo">
						...
						<p class="gdsPrice">
							<span>가격</span><fmt:formatNumber pattern="###,###,###" value="${view.gdsPrice}" />원</p>
						<p class="gdsStock">
					...
					<c:if test="${member != null}">
						<section class="replyForm">
							<form role="form" method="post" autocomplete="off">
								...
								<div class="input_area">
									<button type="button" id="reply_btn" class="btn btn-warning">리뷰 작성</button>
									<script>
	...
	if(modifyConfirm) {
		...
		$.ajax({
			...
			success : function(result){
				...
				if(result == 1) { //작성자와 현재 세션 사용자가 같으면
					replyList();
